	...
	var _class = function () {
		...
		(0, _createClass3.default)(_class, [{
			...
			value: function blockClick(e) {
				...
				// const pos = $target.css('left');
				var pos = $target.getComputedStyle($target);
				console.log(pos);
				if (pos > 100) {
					console.log("MORE");
				}
			...
			value: function render() {
				if (this.$el.length) {
					...
					this.$block.on('click', this.blockClick.bind(this));
				}
				return this;
			}
		}]);
...
//# sourceMappingURL=0.1bcadb9b5ba0503871ce.hot-update.js.map